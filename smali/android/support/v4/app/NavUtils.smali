...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroid/support/v4/app/NavUtils$c;,
        Landroid/support/v4/app/NavUtils$b;,
        Landroid/support/v4/app/NavUtils$a;
    }
.end annotation
...
.field private static final a:Landroid/support/v4/app/NavUtils$a;
...
.method static constructor <clinit>()V
    ...
    .line 138
    new-instance v0, Landroid/support/v4/app/NavUtils$c;

    invoke-direct {v0}, Landroid/support/v4/app/NavUtils$c;-><init>()V

    sput-object v0, Landroid/support/v4/app/NavUtils;->a:Landroid/support/v4/app/NavUtils$a;
    ...
    .line 140
    :cond_0
    new-instance v0, Landroid/support/v4/app/NavUtils$b;

    invoke-direct {v0}, Landroid/support/v4/app/NavUtils$b;-><init>()V
...
.method public static getParentActivityIntent(Landroid/app/Activity;)Landroid/content/Intent;
    ...
    .prologue
    .line 216
    sget-object v0, Landroid/support/v4/app/NavUtils;->a:Landroid/support/v4/app/NavUtils$a;

    invoke-interface {v0, p0}, Landroid/support/v4/app/NavUtils$a;->a(Landroid/app/Activity;)Landroid/content/Intent;
...
.method public static getParentActivityName(Landroid/content/Context;Landroid/content/ComponentName;)Ljava/lang/String;
    ...
    .line 302
    sget-object v1, Landroid/support/v4/app/NavUtils;->a:Landroid/support/v4/app/NavUtils$a;

    invoke-interface {v1, p0, v0}, Landroid/support/v4/app/NavUtils$a;->a(Landroid/content/Context;Landroid/content/pm/ActivityInfo;)Ljava/lang/String;
...
.method public static navigateUpTo(Landroid/app/Activity;Landroid/content/Intent;)V
    ...
    invoke-interface {v0, p0, p1}, Landroid/support/v4/app/NavUtils$a;->b(Landroid/app/Activity;Landroid/content/Intent;)V
...
.method public static shouldUpRecreateTask(Landroid/app/Activity;Landroid/content/Intent;)Z
    ...
    invoke-interface {v0, p0, p1}, Landroid/support/v4/app/NavUtils$a;->a(Landroid/app/Activity;Landroid/content/Intent;)Z
