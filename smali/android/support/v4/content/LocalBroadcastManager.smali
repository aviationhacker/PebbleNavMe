...
.method private a()V
    ...
    .line 290
    :cond_1
    new-array v4, v0, [Landroid/support/v4/content/LocalBroadcastManager$a;
    ...
    .line 296
    :goto_1
    iget-object v0, v5, Landroid/support/v4/content/LocalBroadcastManager$a;->b:Ljava/util/ArrayList;
    ...
    check-cast v0, Landroid/support/v4/content/LocalBroadcastManager$b;

    iget-object v0, v0, Landroid/support/v4/content/LocalBroadcastManager$b;->b:Landroid/content/BroadcastReceiver;

    iget-object v6, p0, Landroid/support/v4/content/LocalBroadcastManager;->a:Landroid/content/Context;

    iget-object v7, v5, Landroid/support/v4/content/LocalBroadcastManager$a;->a:Landroid/content/Intent;
...
.method public registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)V
    ...
    .line 135
    :try_start_0
    new-instance v3, Landroid/support/v4/content/LocalBroadcastManager$b;

    invoke-direct {v3, p2, p1}, Landroid/support/v4/content/LocalBroadcastManager$b;-><init>(Landroid/content/IntentFilter;Landroid/content/BroadcastReceiver;)V
...
.method public sendBroadcast(Landroid/content/Intent;)Z
    ...
    iget-object v14, v9, Landroid/support/v4/content/LocalBroadcastManager$b;->a:Landroid/content/IntentFilter;
    ...
    .line 224
    :cond_2
    iget-boolean v1, v9, Landroid/support/v4/content/LocalBroadcastManager$b;->c:Z
    ...
    .line 231
    :cond_4
    iget-object v1, v9, Landroid/support/v4/content/LocalBroadcastManager$b;->a:Landroid/content/IntentFilter;
    ...
    iput-boolean v7, v9, Landroid/support/v4/content/LocalBroadcastManager$b;->c:Z
    ...
    check-cast v1, Landroid/support/v4/content/LocalBroadcastManager$b;

    const/4 v3, 0x0

    iput-boolean v3, v1, Landroid/support/v4/content/LocalBroadcastManager$b;->c:Z
    ...
    new-instance v2, Landroid/support/v4/content/LocalBroadcastManager$a;

    move-object/from16 v0, p1

    invoke-direct {v2, v0, v10}, Landroid/support/v4/content/LocalBroadcastManager$a;-><init>(Landroid/content/Intent;Ljava/util/ArrayList;)V
...
.method public unregisterReceiver(Landroid/content/BroadcastReceiver;)V
    ...
    check-cast v3, Landroid/support/v4/content/LocalBroadcastManager$b;

    iget-object v3, v3, Landroid/support/v4/content/LocalBroadcastManager$b;->b:Landroid/content/BroadcastReceiver;
