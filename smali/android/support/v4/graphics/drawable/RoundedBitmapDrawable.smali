...
.method protected constructor <init>(Landroid/content/res/Resources;Landroid/graphics/Bitmap;)V
    ...
    iput-object v0, p0, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->e:Landroid/graphics/Paint;
    ...
    iput-object v0, p0, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->g:Landroid/graphics/Matrix;
    ...
    iput-object v0, p0, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->f:Landroid/graphics/BitmapShader;
...
.method private b()V
    ...
    iget v1, p0, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->c:I
...
.method private c()V
    ...
    iput v0, p0, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->h:F
...
.method protected a()V
    ...
    iget v1, p0, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->m:I
    ...
    .line 239
    iget-object v0, p0, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->f:Landroid/graphics/BitmapShader;

    if-eqz v0, :cond_0

    .line 241
    iget-object v0, p0, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->g:Landroid/graphics/Matrix;

    iget-object v1, p0, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->i:Landroid/graphics/RectF;
    ...
    iget-object v2, p0, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->a:Landroid/graphics/Bitmap;
    ...
    iget-object v1, p0, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->g:Landroid/graphics/Matrix;

    invoke-virtual {v0, v1}, Landroid/graphics/BitmapShader;->setLocalMatrix(Landroid/graphics/Matrix;)V

    .line 246
    iget-object v0, p0, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->e:Landroid/graphics/Paint;

    iget-object v1, p0, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->f:Landroid/graphics/BitmapShader;

    invoke-virtual {v0, v1}, Landroid/graphics/Paint;->setShader(Landroid/graphics/Shader;)Landroid/graphics/Shader;

    .line 249
    :cond_0
    iput-boolean v6, p0, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->j:Z
    ...
    iget v3, p0, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->m:I
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    .line 261
    iget-object v1, p0, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->e:Landroid/graphics/Paint;
    ...
    iget-object v3, p0, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->e:Landroid/graphics/Paint;
...
.method public getOpacity()I
    ...
    iget-boolean v1, p0, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->k:Z
