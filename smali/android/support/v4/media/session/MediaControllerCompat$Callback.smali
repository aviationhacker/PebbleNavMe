...
.field private b:Landroid/support/v4/media/session/MediaControllerCompat$Callback$a;
...
.method public constructor <init>()V
    ...
    invoke-direct {v0, p0, v2}, Landroid/support/v4/media/session/MediaControllerCompat$Callback$b;-><init>(Landroid/support/v4/media/session/MediaControllerCompat$Callback;Landroid/support/v4/media/session/MediaControllerCompat$1;)V
    ...
    invoke-direct {v0, p0, v2}, Landroid/support/v4/media/session/MediaControllerCompat$Callback$c;-><init>(Landroid/support/v4/media/session/MediaControllerCompat$Callback;Landroid/support/v4/media/session/MediaControllerCompat$1;)V
...
.method static synthetic a(Landroid/support/v4/media/session/MediaControllerCompat$Callback;)Landroid/support/v4/media/session/MediaControllerCompat$Callback$a;
    .locals 1
...
.method static synthetic a(Landroid/support/v4/media/session/MediaControllerCompat$Callback;Landroid/os/Handler;)V
    ...
    .prologue
    .line 339
    invoke-direct {p0, p1}, Landroid/support/v4/media/session/MediaControllerCompat$Callback;->a(Landroid/os/Handler;)V

    return-void
.end method

.method static synthetic a(Landroid/support/v4/media/session/MediaControllerCompat$Callback;Z)Z
    .locals 0
...
.method static synthetic c(Landroid/support/v4/media/session/MediaControllerCompat$Callback;)Ljava/lang/Object;
    .locals 1
