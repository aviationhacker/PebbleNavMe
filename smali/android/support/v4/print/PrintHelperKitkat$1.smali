...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroid/support/v4/print/PrintHelperKitkat;->a(Ljava/lang/String;Landroid/graphics/Bitmap;Landroid/support/v4/print/PrintHelperKitkat$OnPrintFinishCallback;)V
.end annotation
...
.method constructor <init>(Landroid/support/v4/print/PrintHelperKitkat;Ljava/lang/String;Landroid/graphics/Bitmap;ILandroid/support/v4/print/PrintHelperKitkat$OnPrintFinishCallback;)V
    ...
    .prologue
    .line 190
    iput-object p1, p0, Landroid/support/v4/print/PrintHelperKitkat$1;->e:Landroid/support/v4/print/PrintHelperKitkat;

    iput-object p2, p0, Landroid/support/v4/print/PrintHelperKitkat$1;->a:Ljava/lang/String;

    iput-object p3, p0, Landroid/support/v4/print/PrintHelperKitkat$1;->b:Landroid/graphics/Bitmap;

    iput p4, p0, Landroid/support/v4/print/PrintHelperKitkat$1;->c:I

    iput-object p5, p0, Landroid/support/v4/print/PrintHelperKitkat$1;->d:Landroid/support/v4/print/PrintHelperKitkat$OnPrintFinishCallback;
...
.method public onLayout(Landroid/print/PrintAttributes;Landroid/print/PrintAttributes;Landroid/os/CancellationSignal;Landroid/print/PrintDocumentAdapter$LayoutResultCallback;Landroid/os/Bundle;)V
    ...
    iget-object v2, p0, Landroid/support/v4/print/PrintHelperKitkat$1;->a:Ljava/lang/String;
...
.method public onWrite([Landroid/print/PageRange;Landroid/os/ParcelFileDescriptor;Landroid/os/CancellationSignal;Landroid/print/PrintDocumentAdapter$WriteResultCallback;)V
    ...
    iget-object v2, p0, Landroid/support/v4/print/PrintHelperKitkat$1;->f:Landroid/print/PrintAttributes;
    ...
    iget-object v2, p0, Landroid/support/v4/print/PrintHelperKitkat$1;->b:Landroid/graphics/Bitmap;

    iget-object v3, p0, Landroid/support/v4/print/PrintHelperKitkat$1;->f:Landroid/print/PrintAttributes;

    invoke-virtual {v3}, Landroid/print/PrintAttributes;->getColorMode()I

    move-result v3

    invoke-static {v0, v2, v3}, Landroid/support/v4/print/PrintHelperKitkat;->a(Landroid/support/v4/print/PrintHelperKitkat;Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    ...
    .line 224
    iget-object v4, p0, Landroid/support/v4/print/PrintHelperKitkat$1;->e:Landroid/support/v4/print/PrintHelperKitkat;
    ...
    iget v7, p0, Landroid/support/v4/print/PrintHelperKitkat$1;->c:I

    invoke-static {v4, v5, v6, v3, v7}, Landroid/support/v4/print/PrintHelperKitkat;->a(Landroid/support/v4/print/PrintHelperKitkat;IILandroid/graphics/RectF;I)Landroid/graphics/Matrix;
    ...
    :cond_1
    :goto_1
    iget-object v0, p0, Landroid/support/v4/print/PrintHelperKitkat$1;->b:Landroid/graphics/Bitmap;
    ...
    :cond_4
    :goto_2
    iget-object v1, p0, Landroid/support/v4/print/PrintHelperKitkat$1;->b:Landroid/graphics/Bitmap;
