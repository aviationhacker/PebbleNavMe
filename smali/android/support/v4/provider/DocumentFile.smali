...
# direct methods
.method protected constructor <init>(Landroid/support/v4/provider/DocumentFile;)V
    .locals 0
...
.method public static fromFile(Ljava/io/File;)Landroid/support/v4/provider/DocumentFile;
    ...
    invoke-direct {v0, v1, p0}, Lcf;-><init>(Landroid/support/v4/provider/DocumentFile;Ljava/io/File;)V
...
.method public static fromSingleUri(Landroid/content/Context;Landroid/net/Uri;)Landroid/support/v4/provider/DocumentFile;
    ...
    invoke-direct {v0, v1, p0, p1}, Lcg;-><init>(Landroid/support/v4/provider/DocumentFile;Landroid/content/Context;Landroid/net/Uri;)V
...
.method public static fromTreeUri(Landroid/content/Context;Landroid/net/Uri;)Landroid/support/v4/provider/DocumentFile;
    ...
    invoke-static {p1}, Lce;->a(Landroid/net/Uri;)Landroid/net/Uri;

    move-result-object v2

    invoke-direct {v0, v1, p0, v2}, Lch;-><init>(Landroid/support/v4/provider/DocumentFile;Landroid/content/Context;Landroid/net/Uri;)V
...
.method public static isDocumentUri(Landroid/content/Context;Landroid/net/Uri;)Z
    ...
    .line 144
    invoke-static {p0, p1}, Lcd;->a(Landroid/content/Context;Landroid/net/Uri;)Z
