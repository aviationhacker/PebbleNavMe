...
.method static constructor <clinit>()V
    ...
    sput v0, Landroid/support/v4/view/GestureDetectorCompat$b;->e:I
    ...
    sput v0, Landroid/support/v4/view/GestureDetectorCompat$b;->f:I
    ...
    sput v0, Landroid/support/v4/view/GestureDetectorCompat$b;->g:I
...
.method static synthetic a(Landroid/support/v4/view/GestureDetectorCompat$b;)Landroid/view/MotionEvent;
    .locals 1

    .prologue
    .line 56
    iget-object v0, p0, Landroid/support/v4/view/GestureDetectorCompat$b;->p:Landroid/view/MotionEvent;
...
.method private a(Landroid/content/Context;)V
    ...
    iput v3, p0, Landroid/support/v4/view/GestureDetectorCompat$b;->c:I
    ...
    iput v0, p0, Landroid/support/v4/view/GestureDetectorCompat$b;->a:I

    .line 181
    mul-int v0, v2, v2

    iput v0, p0, Landroid/support/v4/view/GestureDetectorCompat$b;->b:I

    .line 182
    return-void
.end method

.method static synthetic a(Landroid/support/v4/view/GestureDetectorCompat$b;Z)Z
    .locals 0

    .prologue
    .line 56
    iput-boolean p1, p0, Landroid/support/v4/view/GestureDetectorCompat$b;->l:Z
...
.method private a(Landroid/view/MotionEvent;Landroid/view/MotionEvent;Landroid/view/MotionEvent;)Z
    ...
    .line 439
    iget-boolean v1, p0, Landroid/support/v4/view/GestureDetectorCompat$b;->o:Z
    ...
    sget v1, Landroid/support/v4/view/GestureDetectorCompat$b;->g:I
    ...
    iget v2, p0, Landroid/support/v4/view/GestureDetectorCompat$b;->b:I
...
.method static synthetic b(Landroid/support/v4/view/GestureDetectorCompat$b;)Landroid/view/GestureDetector$OnGestureListener;
    .locals 1
...
.method private b()V
    ...
    .line 418
    iput-boolean v2, p0, Landroid/support/v4/view/GestureDetectorCompat$b;->l:Z
    ...
    .line 420
    iput-boolean v2, p0, Landroid/support/v4/view/GestureDetectorCompat$b;->m:Z
...
.method static synthetic c(Landroid/support/v4/view/GestureDetectorCompat$b;)V
    .locals 0
...
.method static synthetic d(Landroid/support/v4/view/GestureDetectorCompat$b;)Landroid/view/GestureDetector$OnDoubleTapListener;
    .locals 1
...
.method static synthetic e(Landroid/support/v4/view/GestureDetectorCompat$b;)Z
    .locals 1

    .prologue
    .line 56
    iget-boolean v0, p0, Landroid/support/v4/view/GestureDetectorCompat$b;->k:Z
...
.method public a(Landroid/view/MotionEvent;)Z
    ...
    iget v2, p0, Landroid/support/v4/view/GestureDetectorCompat$b;->d:I
    ...
    iget-object v4, p0, Landroid/support/v4/view/GestureDetectorCompat$b;->h:Landroid/os/Handler;

    invoke-virtual {v4, v11}, Landroid/os/Handler;->removeMessages(I)V

    .line 287
    :cond_9
    iget-object v4, p0, Landroid/support/v4/view/GestureDetectorCompat$b;->p:Landroid/view/MotionEvent;

    if-eqz v4, :cond_c

    iget-object v4, p0, Landroid/support/v4/view/GestureDetectorCompat$b;->q:Landroid/view/MotionEvent;
    ...
    invoke-direct {p0, v0, v4, p1}, Landroid/support/v4/view/GestureDetectorCompat$b;->a(Landroid/view/MotionEvent;Landroid/view/MotionEvent;Landroid/view/MotionEvent;)Z
    ...
    .line 290
    iput-boolean v8, p0, Landroid/support/v4/view/GestureDetectorCompat$b;->r:Z
    ...
    .line 294
    iget-object v4, p0, Landroid/support/v4/view/GestureDetectorCompat$b;->j:Landroid/view/GestureDetector$OnDoubleTapListener;
    ...
    .line 307
    iput-boolean v8, p0, Landroid/support/v4/view/GestureDetectorCompat$b;->n:Z

    .line 308
    iput-boolean v8, p0, Landroid/support/v4/view/GestureDetectorCompat$b;->o:Z

    .line 309
    iput-boolean v8, p0, Landroid/support/v4/view/GestureDetectorCompat$b;->k:Z
    ...
    iget-object v2, p0, Landroid/support/v4/view/GestureDetectorCompat$b;->p:Landroid/view/MotionEvent;

    invoke-virtual {v2}, Landroid/view/MotionEvent;->getDownTime()J

    move-result-wide v2

    sget v4, Landroid/support/v4/view/GestureDetectorCompat$b;->f:I

    int-to-long v4, v4

    add-long/2addr v2, v4

    sget v4, Landroid/support/v4/view/GestureDetectorCompat$b;->e:I
    ...
    sget v4, Landroid/support/v4/view/GestureDetectorCompat$b;->g:I
    ...
    .line 327
    iget v4, p0, Landroid/support/v4/view/GestureDetectorCompat$b;->t:F
    ...
    .line 335
    iget v6, p0, Landroid/support/v4/view/GestureDetectorCompat$b;->a:I

    if-le v5, v6, :cond_1a

    .line 336
    iget-object v6, p0, Landroid/support/v4/view/GestureDetectorCompat$b;->i:Landroid/view/GestureDetector$OnGestureListener;
    ...
    .line 344
    :goto_8
    iget v1, p0, Landroid/support/v4/view/GestureDetectorCompat$b;->a:I
    ...
    .line 348
    :cond_11
    iget-object v3, p0, Landroid/support/v4/view/GestureDetectorCompat$b;->i:Landroid/view/GestureDetector$OnGestureListener;

    iget-object v5, p0, Landroid/support/v4/view/GestureDetectorCompat$b;->p:Landroid/view/MotionEvent;
    ...
    .line 365
    iget-boolean v2, p0, Landroid/support/v4/view/GestureDetectorCompat$b;->l:Z

    if-eqz v2, :cond_12

    iget-object v2, p0, Landroid/support/v4/view/GestureDetectorCompat$b;->j:Landroid/view/GestureDetector$OnDoubleTapListener;
    ...
    iget v5, p0, Landroid/support/v4/view/GestureDetectorCompat$b;->d:I
    ...
    iget v5, p0, Landroid/support/v4/view/GestureDetectorCompat$b;->c:I
