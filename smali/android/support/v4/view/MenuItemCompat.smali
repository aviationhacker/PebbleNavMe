...
.field static final a:Landroid/support/v4/view/MenuItemCompat$d;
...
.method static constructor <clinit>()V
    ...
    .line 249
    new-instance v0, Landroid/support/v4/view/MenuItemCompat$c;

    invoke-direct {v0}, Landroid/support/v4/view/MenuItemCompat$c;-><init>()V

    sput-object v0, Landroid/support/v4/view/MenuItemCompat;->a:Landroid/support/v4/view/MenuItemCompat$d;
...
.method public static collapseActionView(Landroid/view/MenuItem;)Z
    ...
    :cond_0
    sget-object v0, Landroid/support/v4/view/MenuItemCompat;->a:Landroid/support/v4/view/MenuItemCompat$d;

    invoke-interface {v0, p0}, Landroid/support/v4/view/MenuItemCompat$d;->c(Landroid/view/MenuItem;)Z
...
.method public static expandActionView(Landroid/view/MenuItem;)Z
    ...
    invoke-interface {v0, p0}, Landroid/support/v4/view/MenuItemCompat$d;->b(Landroid/view/MenuItem;)Z
...
.method public static getActionView(Landroid/view/MenuItem;)Landroid/view/View;
    ...
    invoke-interface {v0, p0}, Landroid/support/v4/view/MenuItemCompat$d;->a(Landroid/view/MenuItem;)Landroid/view/View;
...
.method public static isActionViewExpanded(Landroid/view/MenuItem;)Z
    ...
    invoke-interface {v0, p0}, Landroid/support/v4/view/MenuItemCompat$d;->d(Landroid/view/MenuItem;)Z
...
.method public static setActionView(Landroid/view/MenuItem;I)Landroid/view/MenuItem;
    ...
    invoke-interface {v0, p0, p1}, Landroid/support/v4/view/MenuItemCompat$d;->b(Landroid/view/MenuItem;I)Landroid/view/MenuItem;
...
.method public static setActionView(Landroid/view/MenuItem;Landroid/view/View;)Landroid/view/MenuItem;
    ...
    invoke-interface {v0, p0, p1}, Landroid/support/v4/view/MenuItemCompat$d;->a(Landroid/view/MenuItem;Landroid/view/View;)Landroid/view/MenuItem;
...
.method public static setOnActionExpandListener(Landroid/view/MenuItem;Landroid/support/v4/view/MenuItemCompat$OnActionExpandListener;)Landroid/view/MenuItem;
    ...
    invoke-interface {v0, p0, p1}, Landroid/support/v4/view/MenuItemCompat$d;->a(Landroid/view/MenuItem;Landroid/support/v4/view/MenuItemCompat$OnActionExpandListener;)Landroid/view/MenuItem;
...
.method public static setShowAsAction(Landroid/view/MenuItem;I)V
    ...
    invoke-interface {v0, p0, p1}, Landroid/support/v4/view/MenuItemCompat$d;->a(Landroid/view/MenuItem;I)V
