...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroid/support/v4/view/accessibility/AccessibilityEventCompat$b;,
        Landroid/support/v4/view/accessibility/AccessibilityEventCompat$a;,
        Landroid/support/v4/view/accessibility/AccessibilityEventCompat$c;,
        Landroid/support/v4/view/accessibility/AccessibilityEventCompat$d;
    }
.end annotation
...
.field private static final a:Landroid/support/v4/view/accessibility/AccessibilityEventCompat$d;
...
.method static constructor <clinit>()V
    ...
    .line 99
    new-instance v0, Landroid/support/v4/view/accessibility/AccessibilityEventCompat$b;

    invoke-direct {v0}, Landroid/support/v4/view/accessibility/AccessibilityEventCompat$b;-><init>()V

    sput-object v0, Landroid/support/v4/view/accessibility/AccessibilityEventCompat;->a:Landroid/support/v4/view/accessibility/AccessibilityEventCompat$d;
    ...
    .line 101
    new-instance v0, Landroid/support/v4/view/accessibility/AccessibilityEventCompat$a;

    invoke-direct {v0}, Landroid/support/v4/view/accessibility/AccessibilityEventCompat$a;-><init>()V
    ...
    .line 103
    :cond_1
    new-instance v0, Landroid/support/v4/view/accessibility/AccessibilityEventCompat$c;

    invoke-direct {v0}, Landroid/support/v4/view/accessibility/AccessibilityEventCompat$c;-><init>()V
...
.method public static appendRecord(Landroid/view/accessibility/AccessibilityEvent;Landroid/support/v4/view/accessibility/AccessibilityRecordCompat;)V
    ...
    .prologue
    .line 257
    sget-object v0, Landroid/support/v4/view/accessibility/AccessibilityEventCompat;->a:Landroid/support/v4/view/accessibility/AccessibilityEventCompat$d;

    invoke-virtual {p1}, Landroid/support/v4/view/accessibility/AccessibilityRecordCompat;->getImpl()Ljava/lang/Object;

    move-result-object v1

    invoke-interface {v0, p0, v1}, Landroid/support/v4/view/accessibility/AccessibilityEventCompat$d;->a(Landroid/view/accessibility/AccessibilityEvent;Ljava/lang/Object;)V
...
.method public static getContentChangeTypes(Landroid/view/accessibility/AccessibilityEvent;)I
    ...
    invoke-interface {v0, p0}, Landroid/support/v4/view/accessibility/AccessibilityEventCompat$d;->b(Landroid/view/accessibility/AccessibilityEvent;)I
...
.method public static getRecord(Landroid/view/accessibility/AccessibilityEvent;I)Landroid/support/v4/view/accessibility/AccessibilityRecordCompat;
    ...
    sget-object v1, Landroid/support/v4/view/accessibility/AccessibilityEventCompat;->a:Landroid/support/v4/view/accessibility/AccessibilityEventCompat$d;

    invoke-interface {v1, p0, p1}, Landroid/support/v4/view/accessibility/AccessibilityEventCompat$d;->a(Landroid/view/accessibility/AccessibilityEvent;I)Ljava/lang/Object;
...
.method public static getRecordCount(Landroid/view/accessibility/AccessibilityEvent;)I
    ...
    invoke-interface {v0, p0}, Landroid/support/v4/view/accessibility/AccessibilityEventCompat$d;->a(Landroid/view/accessibility/AccessibilityEvent;)I
...
.method public static setContentChangeTypes(Landroid/view/accessibility/AccessibilityEvent;I)V
    ...
    invoke-interface {v0, p0, p1}, Landroid/support/v4/view/accessibility/AccessibilityEventCompat$d;->b(Landroid/view/accessibility/AccessibilityEvent;I)V
