...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroid/support/v7/internal/app/ToolbarActionBar$b;,
        Landroid/support/v7/internal/app/ToolbarActionBar$c;,
        Landroid/support/v7/internal/app/ToolbarActionBar$a;,
        Landroid/support/v7/internal/app/ToolbarActionBar$d;
    }
.end annotation
...
.field private g:Landroid/support/v7/internal/view/menu/ListMenuPresenter;
...
.method public constructor <init>(Landroid/support/v7/widget/Toolbar;Ljava/lang/CharSequence;Landroid/view/Window$Callback;)V
    ...
    iput-object v0, p0, Landroid/support/v7/internal/app/ToolbarActionBar;->i:Landroid/support/v7/widget/Toolbar$OnMenuItemClickListener;
    ...
    .line 79
    new-instance v0, Landroid/support/v7/internal/app/ToolbarActionBar$d;

    invoke-direct {v0, p0, p3}, Landroid/support/v7/internal/app/ToolbarActionBar$d;-><init>(Landroid/support/v7/internal/app/ToolbarActionBar;Landroid/view/Window$Callback;)V
    ...
    .line 81
    iget-object v0, p0, Landroid/support/v7/internal/app/ToolbarActionBar;->i:Landroid/support/v7/widget/Toolbar$OnMenuItemClickListener;
...
.method private a(Landroid/view/Menu;)Landroid/view/View;
    ...
    iget-object v1, p0, Landroid/support/v7/internal/app/ToolbarActionBar;->g:Landroid/support/v7/internal/view/menu/ListMenuPresenter;
    ...
    .line 510
    iget-object v0, p0, Landroid/support/v7/internal/app/ToolbarActionBar;->g:Landroid/support/v7/internal/view/menu/ListMenuPresenter;
...
.method private b()Landroid/view/Menu;
    ...
    new-instance v1, Landroid/support/v7/internal/app/ToolbarActionBar$a;

    invoke-direct {v1, p0, v3}, Landroid/support/v7/internal/app/ToolbarActionBar$a;-><init>(Landroid/support/v7/internal/app/ToolbarActionBar;Landroid/support/v7/internal/app/ToolbarActionBar$1;)V

    new-instance v2, Landroid/support/v7/internal/app/ToolbarActionBar$b;

    invoke-direct {v2, p0, v3}, Landroid/support/v7/internal/app/ToolbarActionBar$b;-><init>(Landroid/support/v7/internal/app/ToolbarActionBar;Landroid/support/v7/internal/app/ToolbarActionBar$1;)V
...
.method private b(Landroid/view/Menu;)V
    ...
    iput-object v0, p0, Landroid/support/v7/internal/app/ToolbarActionBar;->g:Landroid/support/v7/internal/view/menu/ListMenuPresenter;

    .line 543
    iget-object v0, p0, Landroid/support/v7/internal/app/ToolbarActionBar;->g:Landroid/support/v7/internal/view/menu/ListMenuPresenter;

    new-instance v1, Landroid/support/v7/internal/app/ToolbarActionBar$c;

    const/4 v2, 0x0

    invoke-direct {v1, p0, v2}, Landroid/support/v7/internal/app/ToolbarActionBar$c;-><init>(Landroid/support/v7/internal/app/ToolbarActionBar;Landroid/support/v7/internal/app/ToolbarActionBar$1;)V
...
.method a()V
    ...
    .line 441
    invoke-direct {p0}, Landroid/support/v7/internal/app/ToolbarActionBar;->b()Landroid/view/Menu;
