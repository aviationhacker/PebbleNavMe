...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroid/support/v7/internal/view/menu/MenuItemWrapperICS$b;,
        Landroid/support/v7/internal/view/menu/MenuItemWrapperICS$a;,
        Landroid/support/v7/internal/view/menu/MenuItemWrapperICS$c;,
        Landroid/support/v7/internal/view/menu/MenuItemWrapperICS$d;
    }
.end annotation
...
# direct methods
.method protected constructor <init>(Landroid/content/Context;Landroid/support/v4/internal/view/SupportMenuItem;)V
    .locals 0

    .prologue
    .line 49
    invoke-direct {p0, p1, p2}, Lfs;-><init>(Landroid/content/Context;Ljava/lang/Object;)V
...
# virtual methods
.method public a(Landroid/view/ActionProvider;)Landroid/support/v7/internal/view/menu/MenuItemWrapperICS$a;
    .locals 2

    .prologue
    .line 309
    new-instance v0, Landroid/support/v7/internal/view/menu/MenuItemWrapperICS$a;

    iget-object v1, p0, Landroid/support/v7/internal/view/menu/MenuItemWrapperICS;->a:Landroid/content/Context;

    invoke-direct {v0, p0, v1, p1}, Landroid/support/v7/internal/view/menu/MenuItemWrapperICS$a;-><init>(Landroid/support/v7/internal/view/menu/MenuItemWrapperICS;Landroid/content/Context;Landroid/view/ActionProvider;)V
...
.method public collapseActionView()Z
    ...
    .prologue
    .line 281
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/MenuItemWrapperICS;->b:Ljava/lang/Object;
...
.method public getActionProvider()Landroid/view/ActionProvider;
    ...
    .line 268
    instance-of v1, v0, Landroid/support/v7/internal/view/menu/MenuItemWrapperICS$a;

    if-eqz v1, :cond_0

    .line 269
    check-cast v0, Landroid/support/v7/internal/view/menu/MenuItemWrapperICS$a;

    iget-object v0, v0, Landroid/support/v7/internal/view/menu/MenuItemWrapperICS$a;->a:Landroid/view/ActionProvider;
...
.method public getActionView()Landroid/view/View;
    ...
    .line 252
    instance-of v1, v0, Landroid/support/v7/internal/view/menu/MenuItemWrapperICS$b;

    if-eqz v1, :cond_0

    .line 253
    check-cast v0, Landroid/support/v7/internal/view/menu/MenuItemWrapperICS$b;

    invoke-virtual {v0}, Landroid/support/v7/internal/view/menu/MenuItemWrapperICS$b;->a()Landroid/view/View;
...
.method public getSubMenu()Landroid/view/SubMenu;
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/internal/view/menu/MenuItemWrapperICS;->a(Landroid/view/SubMenu;)Landroid/view/SubMenu;
...
.method public setActionProvider(Landroid/view/ActionProvider;)Landroid/view/MenuItem;
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/internal/view/menu/MenuItemWrapperICS;->a(Landroid/view/ActionProvider;)Landroid/support/v7/internal/view/menu/MenuItemWrapperICS$a;
...
.method public setActionView(I)Landroid/view/MenuItem;
    ...
    new-instance v2, Landroid/support/v7/internal/view/menu/MenuItemWrapperICS$b;

    invoke-direct {v2, v1}, Landroid/support/v7/internal/view/menu/MenuItemWrapperICS$b;-><init>(Landroid/view/View;)V
...
.method public setActionView(Landroid/view/View;)Landroid/view/MenuItem;
    ...
    .line 230
    new-instance v0, Landroid/support/v7/internal/view/menu/MenuItemWrapperICS$b;

    invoke-direct {v0, p1}, Landroid/support/v7/internal/view/menu/MenuItemWrapperICS$b;-><init>(Landroid/view/View;)V
...
.method public setExclusiveCheckable(Z)V
    ...
    .line 298
    :try_start_0
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/MenuItemWrapperICS;->c:Ljava/lang/reflect/Method;
    ...
    iput-object v0, p0, Landroid/support/v7/internal/view/menu/MenuItemWrapperICS;->c:Ljava/lang/reflect/Method;

    .line 302
    :cond_0
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/MenuItemWrapperICS;->c:Ljava/lang/reflect/Method;

    iget-object v1, p0, Landroid/support/v7/internal/view/menu/MenuItemWrapperICS;->b:Ljava/lang/Object;
...
.method public setOnActionExpandListener(Landroid/view/MenuItem$OnActionExpandListener;)Landroid/view/MenuItem;
    ...
    new-instance v1, Landroid/support/v7/internal/view/menu/MenuItemWrapperICS$c;

    invoke-direct {v1, p0, p1}, Landroid/support/v7/internal/view/menu/MenuItemWrapperICS$c;-><init>(Landroid/support/v7/internal/view/menu/MenuItemWrapperICS;Landroid/view/MenuItem$OnActionExpandListener;)V
...
.method public setOnMenuItemClickListener(Landroid/view/MenuItem$OnMenuItemClickListener;)Landroid/view/MenuItem;
    ...
    new-instance v1, Landroid/support/v7/internal/view/menu/MenuItemWrapperICS$d;

    invoke-direct {v1, p0, p1}, Landroid/support/v7/internal/view/menu/MenuItemWrapperICS$d;-><init>(Landroid/support/v7/internal/view/menu/MenuItemWrapperICS;Landroid/view/MenuItem$OnMenuItemClickListener;)V
