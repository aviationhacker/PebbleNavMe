...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Landroid/support/v7/internal/widget/ScrollingTabContainerView$c;
    }
.end annotation
...
.field private d:Landroid/support/v7/internal/widget/ScrollingTabContainerView$b;
...
.method private a(Landroid/support/v7/app/ActionBar$Tab;Z)Landroid/support/v7/internal/widget/ScrollingTabContainerView$c;
    .locals 4
    ...
    .line 292
    new-instance v0, Landroid/support/v7/internal/widget/ScrollingTabContainerView$c;

    invoke-virtual {p0}, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->getContext()Landroid/content/Context;

    move-result-object v1

    invoke-direct {v0, p0, v1, p1, p2}, Landroid/support/v7/internal/widget/ScrollingTabContainerView$c;-><init>(Landroid/support/v7/internal/widget/ScrollingTabContainerView;Landroid/content/Context;Landroid/support/v7/app/ActionBar$Tab;Z)V

    .line 293
    if-eqz p2, :cond_0

    .line 294
    invoke-virtual {v0, v2}, Landroid/support/v7/internal/widget/ScrollingTabContainerView$c;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/internal/widget/ScrollingTabContainerView$c;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/internal/widget/ScrollingTabContainerView$c;->setFocusable(Z)V

    .line 300
    iget-object v1, p0, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->d:Landroid/support/v7/internal/widget/ScrollingTabContainerView$b;

    if-nez v1, :cond_1

    .line 301
    new-instance v1, Landroid/support/v7/internal/widget/ScrollingTabContainerView$b;

    invoke-direct {v1, p0, v2}, Landroid/support/v7/internal/widget/ScrollingTabContainerView$b;-><init>(Landroid/support/v7/internal/widget/ScrollingTabContainerView;Landroid/support/v7/internal/widget/ScrollingTabContainerView$1;)V

    iput-object v1, p0, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->d:Landroid/support/v7/internal/widget/ScrollingTabContainerView$b;

    .line 303
    :cond_1
    iget-object v1, p0, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->d:Landroid/support/v7/internal/widget/ScrollingTabContainerView$b;

    invoke-virtual {v0, v1}, Landroid/support/v7/internal/widget/ScrollingTabContainerView$c;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    goto :goto_0
.end method

.method static synthetic a(Landroid/support/v7/internal/widget/ScrollingTabContainerView;Landroid/support/v7/app/ActionBar$Tab;Z)Landroid/support/v7/internal/widget/ScrollingTabContainerView$c;
    .locals 1

    .prologue
    .line 57
    invoke-direct {p0, p1, p2}, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->a(Landroid/support/v7/app/ActionBar$Tab;Z)Landroid/support/v7/internal/widget/ScrollingTabContainerView$c;
...
.method private a()Z
    ...
    .prologue
    .line 145
    iget-object v0, p0, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->f:Landroid/widget/Spinner;
...
.method private b()V
    ...
    .line 156
    invoke-direct {p0}, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->e()Landroid/widget/Spinner;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->f:Landroid/widget/Spinner;
    ...
    new-instance v1, Landroid/support/v7/internal/widget/ScrollingTabContainerView$a;

    invoke-direct {v1, p0, v4}, Landroid/support/v7/internal/widget/ScrollingTabContainerView$a;-><init>(Landroid/support/v7/internal/widget/ScrollingTabContainerView;Landroid/support/v7/internal/widget/ScrollingTabContainerView$1;)V
...
.method public addTab(Landroid/support/v7/app/ActionBar$Tab;IZ)V
    ...
    .line 324
    invoke-direct {p0, p1, v5}, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->a(Landroid/support/v7/app/ActionBar$Tab;Z)Landroid/support/v7/internal/widget/ScrollingTabContainerView$c;
    ...
    check-cast v0, Landroid/support/v7/internal/widget/ScrollingTabContainerView$a;

    invoke-virtual {v0}, Landroid/support/v7/internal/widget/ScrollingTabContainerView$a;->notifyDataSetChanged()V
    ...
    invoke-virtual {v1, v0}, Landroid/support/v7/internal/widget/ScrollingTabContainerView$c;->setSelected(Z)V
...
.method public onItemSelected(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    .prologue
    .line 370
    check-cast p2, Landroid/support/v7/internal/widget/ScrollingTabContainerView$c;

    .line 371
    invoke-virtual {p2}, Landroid/support/v7/internal/widget/ScrollingTabContainerView$c;->b()Landroid/support/v7/app/ActionBar$Tab;
...
.method public updateTab(I)V
    ...
    check-cast v0, Landroid/support/v7/internal/widget/ScrollingTabContainerView$c;

    invoke-virtual {v0}, Landroid/support/v7/internal/widget/ScrollingTabContainerView$c;->a()V
