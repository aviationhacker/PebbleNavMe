...
.method public constructor <init>(Landroid/support/v7/widget/ActionMenuPresenter;Landroid/content/Context;Landroid/support/v7/internal/view/menu/SubMenuBuilder;)V
    ...
    .line 718
    iput-object p3, p0, Landroid/support/v7/widget/ActionMenuPresenter$a;->d:Landroid/support/v7/internal/view/menu/SubMenuBuilder;
    ...
    .line 723
    invoke-static {p1}, Landroid/support/v7/widget/ActionMenuPresenter;->d(Landroid/support/v7/widget/ActionMenuPresenter;)Landroid/support/v7/widget/ActionMenuPresenter$d;
    ...
    :goto_0
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/ActionMenuPresenter$a;->setAnchorView(Landroid/view/View;)V

    .line 726
    :cond_0
    iget-object v0, p1, Landroid/support/v7/widget/ActionMenuPresenter;->a:Landroid/support/v7/widget/ActionMenuPresenter$f;

    invoke-virtual {p0, v0}, Landroid/support/v7/widget/ActionMenuPresenter$a;->setCallback(Landroid/support/v7/internal/view/menu/MenuPresenter$Callback;)V
    ...
    .line 737
    :cond_1
    invoke-virtual {p0, v4}, Landroid/support/v7/widget/ActionMenuPresenter$a;->setForceShowIcon(Z)V
