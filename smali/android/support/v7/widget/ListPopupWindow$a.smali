...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    .line 1551
    iput-boolean p2, p0, Landroid/support/v7/widget/ListPopupWindow$a;->g:Z
...
.method private a()V
    ...
    .line 1627
    iput-boolean v0, p0, Landroid/support/v7/widget/ListPopupWindow$a;->h:Z

    .line 1628
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/ListPopupWindow$a;->setPressed(Z)V

    .line 1630
    invoke-virtual {p0}, Landroid/support/v7/widget/ListPopupWindow$a;->drawableStateChanged()V

    .line 1632
    iget-object v0, p0, Landroid/support/v7/widget/ListPopupWindow$a;->i:Landroid/support/v4/view/ViewPropertyAnimatorCompat;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ListPopupWindow$a;->i:Landroid/support/v4/view/ViewPropertyAnimatorCompat;
...
.method private a(Landroid/view/View;I)V
    ...
    .prologue
    .line 1622
    invoke-virtual {p0, p2}, Landroid/support/v7/widget/ListPopupWindow$a;->getItemIdAtPosition(I)J

    move-result-wide v0

    .line 1623
    invoke-virtual {p0, p1, p2, v0, v1}, Landroid/support/v7/widget/ListPopupWindow$a;->performItemClick(Landroid/view/View;IJ)Z
...
.method private a(Landroid/view/View;IFF)V
    ...
    .line 1647
    invoke-virtual {p0, p2}, Landroid/support/v7/widget/ListPopupWindow$a;->setSelection(I)V

    .line 1648
    invoke-virtual {p0, p2, p1, p3, p4}, Landroid/support/v7/widget/ListPopupWindow$a;->positionSelectorLikeTouchCompat(ILandroid/view/View;FF)V

    .line 1653
    const/4 v0, 0x0

    invoke-virtual {p0, v0}, Landroid/support/v7/widget/ListPopupWindow$a;->setSelectorEnabled(Z)V
...
.method static synthetic a(Landroid/support/v7/widget/ListPopupWindow$a;Z)Z
    ...
    .prologue
    .line 1498
    iput-boolean p1, p0, Landroid/support/v7/widget/ListPopupWindow$a;->f:Z
...
.method public a(Landroid/view/MotionEvent;I)Z
    ...
    .line 1600
    :cond_1
    invoke-direct {p0}, Landroid/support/v7/widget/ListPopupWindow$a;->a()V
    ...
    .line 1605
    iget-object v0, p0, Landroid/support/v7/widget/ListPopupWindow$a;->j:Landroid/support/v4/widget/ListViewAutoScrollHelper;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ListPopupWindow$a;->j:Landroid/support/v4/widget/ListViewAutoScrollHelper;
    ...
    invoke-direct {p0, v0, v6, v5, v4}, Landroid/support/v7/widget/ListPopupWindow$a;->a(Landroid/view/View;IFF)V

    .line 1592
    if-ne v3, v2, :cond_0

    .line 1593
    invoke-direct {p0, v0, v6}, Landroid/support/v7/widget/ListPopupWindow$a;->a(Landroid/view/View;I)V
...
.method public hasFocus()Z
    ...
    .prologue
    .line 1698
    iget-boolean v0, p0, Landroid/support/v7/widget/ListPopupWindow$a;->g:Z
...
.method public isInTouchMode()Z
    ...
    iget-boolean v0, p0, Landroid/support/v7/widget/ListPopupWindow$a;->f:Z
...
.method protected touchModeDrawsInPressedStateCompat()Z
    ...
    .prologue
    .line 1662
    iget-boolean v0, p0, Landroid/support/v7/widget/ListPopupWindow$a;->h:Z
