...
.field private f:Landroid/support/v7/widget/ListPopupWindow$a;
...
.field private final v:Landroid/support/v7/widget/ListPopupWindow$f;

.field private final w:Landroid/support/v7/widget/ListPopupWindow$e;

.field private final x:Landroid/support/v7/widget/ListPopupWindow$d;

.field private final y:Landroid/support/v7/widget/ListPopupWindow$b;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/v7/widget/ListPopupWindow$f;-><init>(Landroid/support/v7/widget/ListPopupWindow;Landroid/support/v7/widget/ListPopupWindow$1;)V

    iput-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->v:Landroid/support/v7/widget/ListPopupWindow$f;

    .line 117
    new-instance v0, Landroid/support/v7/widget/ListPopupWindow$e;

    invoke-direct {v0, p0, v1}, Landroid/support/v7/widget/ListPopupWindow$e;-><init>(Landroid/support/v7/widget/ListPopupWindow;Landroid/support/v7/widget/ListPopupWindow$1;)V

    iput-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->w:Landroid/support/v7/widget/ListPopupWindow$e;

    .line 118
    new-instance v0, Landroid/support/v7/widget/ListPopupWindow$d;

    invoke-direct {v0, p0, v1}, Landroid/support/v7/widget/ListPopupWindow$d;-><init>(Landroid/support/v7/widget/ListPopupWindow;Landroid/support/v7/widget/ListPopupWindow$1;)V

    iput-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->x:Landroid/support/v7/widget/ListPopupWindow$d;

    .line 119
    new-instance v0, Landroid/support/v7/widget/ListPopupWindow$b;

    invoke-direct {v0, p0, v1}, Landroid/support/v7/widget/ListPopupWindow$b;-><init>(Landroid/support/v7/widget/ListPopupWindow;Landroid/support/v7/widget/ListPopupWindow$1;)V

    iput-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->y:Landroid/support/v7/widget/ListPopupWindow$b;
...
.method static synthetic a(Landroid/support/v7/widget/ListPopupWindow;)Landroid/support/v7/widget/ListPopupWindow$a;
    ...
    .prologue
    .line 65
    iget-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->f:Landroid/support/v7/widget/ListPopupWindow$a;
...
.method private a(Z)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ListPopupWindow;->d:Landroid/widget/PopupWindow;
...
.method private b()I
    ...
    .line 1052
    iget-object v5, p0, Landroid/support/v7/widget/ListPopupWindow;->c:Landroid/content/Context;
    ...
    .line 1070
    new-instance v4, Landroid/support/v7/widget/ListPopupWindow$a;
    ...
    :goto_0
    invoke-direct {v4, v5, v0}, Landroid/support/v7/widget/ListPopupWindow$a;-><init>(Landroid/content/Context;Z)V

    iput-object v4, p0, Landroid/support/v7/widget/ListPopupWindow;->f:Landroid/support/v7/widget/ListPopupWindow$a;
    ...
    iget-object v4, p0, Landroid/support/v7/widget/ListPopupWindow;->s:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v0, v4}, Landroid/support/v7/widget/ListPopupWindow$a;->setSelector(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v0, v4}, Landroid/support/v7/widget/ListPopupWindow$a;->setAdapter(Landroid/widget/ListAdapter;)V

    .line 1075
    iget-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->f:Landroid/support/v7/widget/ListPopupWindow$a;

    iget-object v4, p0, Landroid/support/v7/widget/ListPopupWindow;->t:Landroid/widget/AdapterView$OnItemClickListener;

    invoke-virtual {v0, v4}, Landroid/support/v7/widget/ListPopupWindow$a;->setOnItemClickListener(Landroid/widget/AdapterView$OnItemClickListener;)V
    ...
    invoke-virtual {v0, v4}, Landroid/support/v7/widget/ListPopupWindow$a;->setOnItemSelectedListener(Landroid/widget/AdapterView$OnItemSelectedListener;)V

    .line 1094
    iget-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->f:Landroid/support/v7/widget/ListPopupWindow$a;

    iget-object v4, p0, Landroid/support/v7/widget/ListPopupWindow;->x:Landroid/support/v7/widget/ListPopupWindow$d;

    invoke-virtual {v0, v4}, Landroid/support/v7/widget/ListPopupWindow$a;->setOnScrollListener(Landroid/widget/AbsListView$OnScrollListener;)V
    ...
    iget-object v4, p0, Landroid/support/v7/widget/ListPopupWindow;->u:Landroid/widget/AdapterView$OnItemSelectedListener;
    ...
    .line 1113
    iget v5, p0, Landroid/support/v7/widget/ListPopupWindow;->p:I
    ...
    invoke-virtual/range {v0 .. v5}, Landroid/support/v7/widget/ListPopupWindow$a;->measureHeightOfChildrenCompat(IIIII)I
...
.method static synthetic c(Landroid/support/v7/widget/ListPopupWindow;)Landroid/support/v7/widget/ListPopupWindow$f;
    .locals 1

    .prologue
    .line 65
    iget-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->v:Landroid/support/v7/widget/ListPopupWindow$f;
...
.method public dismiss()V
    ...
    .line 674
    iput-object v1, p0, Landroid/support/v7/widget/ListPopupWindow;->f:Landroid/support/v7/widget/ListPopupWindow$a;

    .line 675
    iget-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->A:Landroid/os/Handler;

    iget-object v1, p0, Landroid/support/v7/widget/ListPopupWindow;->v:Landroid/support/v7/widget/ListPopupWindow$f;
...
.method public getVerticalOffset()I
    ...
    .prologue
    .line 458
    iget-boolean v0, p0, Landroid/support/v7/widget/ListPopupWindow;->k:Z
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    .line 892
    :cond_5
    iget-object v4, p0, Landroid/support/v7/widget/ListPopupWindow;->f:Landroid/support/v7/widget/ListPopupWindow$a;

    invoke-virtual {v4, v2, v1}, Landroid/support/v7/widget/ListPopupWindow$a;->lookForSelectablePosition(IZ)I
    ...
    .line 894
    :cond_6
    iget-object v3, p0, Landroid/support/v7/widget/ListPopupWindow;->f:Landroid/support/v7/widget/ListPopupWindow$a;
    ...
    invoke-virtual {v3, v6, v2}, Landroid/support/v7/widget/ListPopupWindow$a;->lookForSelectablePosition(IZ)I
    ...
    .line 909
    :cond_7
    iget-object v6, p0, Landroid/support/v7/widget/ListPopupWindow;->f:Landroid/support/v7/widget/ListPopupWindow$a;
...
.method public performItemClick(I)Z
    ...
    .line 780
    iget-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->t:Landroid/widget/AdapterView$OnItemClickListener;
...
.method public postShow()V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ListPopupWindow;->z:Ljava/lang/Runnable;
...
.method public setAdapter(Landroid/widget/ListAdapter;)V
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/v7/widget/ListPopupWindow$c;-><init>(Landroid/support/v7/widget/ListPopupWindow;Landroid/support/v7/widget/ListPopupWindow$1;)V
...
.method public setDropDownAlwaysVisible(Z)V
    ...
    .prologue
    .line 340
    iput-boolean p1, p0, Landroid/support/v7/widget/ListPopupWindow;->m:Z
...
.method public setListSelector(Landroid/graphics/drawable/Drawable;)V
    ...
    .prologue
    .line 382
    iput-object p1, p0, Landroid/support/v7/widget/ListPopupWindow;->s:Landroid/graphics/drawable/Drawable;
...
.method public setOnItemSelectedListener(Landroid/widget/AdapterView$OnItemSelectedListener;)V
    ...
    .prologue
    .line 552
    iput-object p1, p0, Landroid/support/v7/widget/ListPopupWindow;->u:Landroid/widget/AdapterView$OnItemSelectedListener;
...
.method public setVerticalOffset(I)V
    ...
    iput-boolean v0, p0, Landroid/support/v7/widget/ListPopupWindow;->k:Z
...
.method public show()V
    ...
    .line 607
    iget-object v2, p0, Landroid/support/v7/widget/ListPopupWindow;->d:Landroid/widget/PopupWindow;
    ...
    iget-boolean v2, p0, Landroid/support/v7/widget/ListPopupWindow;->n:Z

    if-nez v2, :cond_1

    iget-boolean v2, p0, Landroid/support/v7/widget/ListPopupWindow;->m:Z
    ...
    .line 647
    :goto_7
    iget-object v5, p0, Landroid/support/v7/widget/ListPopupWindow;->d:Landroid/widget/PopupWindow;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ListPopupWindow;->w:Landroid/support/v7/widget/ListPopupWindow$e;
    ...
    iget v3, p0, Landroid/support/v7/widget/ListPopupWindow;->i:I
    ...
    invoke-virtual {v1, v0}, Landroid/support/v7/widget/ListPopupWindow$a;->setSelection(I)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ListPopupWindow;->y:Landroid/support/v7/widget/ListPopupWindow$b;
