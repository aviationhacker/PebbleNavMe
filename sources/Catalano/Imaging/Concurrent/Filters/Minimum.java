...
public class Minimum implements IApplyInPlace {
    ...
    class a implements Runnable {
        ...
        public void run() {
            int i;
            int iA = a(Minimum.this.a);
            int i2 = Minimum.this.a;
                ...
                for (int i3 = this.b.startX; i3 < this.b.endHeight; i3++) {
                    for (int i4 = 0; i4 < this.b.fastBitmap.getWidth(); i4++) {
                        ...
                        for (int i5 = 0; i5 < iA; i5++) {
                            int i6 = i3 + (i5 - Minimum.this.a);
                            for (int i7 = 0; i7 < iA; i7++) {
                                int i8 = (i7 - Minimum.this.a) + i4;
                                if (i6 >= 0 && i6 < this.b.endHeight + i && i8 >= 0 && i8 < this.b.fastBitmap.getWidth() && Minimum.this.b.getGray(i6, i8) < gray) {
                                    gray = Minimum.this.b.getGray(i6, i8);
                                }
                            }
                        }
            ...
            for (int i9 = this.b.startX; i9 < this.b.endHeight; i9++) {
                for (int i10 = 0; i10 < this.b.fastBitmap.getWidth(); i10++) {
                    ...
                    int i14 = 255;
                    while (i11 < iA) {
                        int i15 = i9 + (i11 - Minimum.this.a);
                        int red = i14;
                        int green = i13;
                        int blue = i12;
                        int i16 = 0;
                        while (i16 < iA) {
                            int i17 = (i16 - Minimum.this.a) + i10;
                            if (i15 >= 0 && i15 < this.b.endHeight + i && i17 >= 0 && i17 < this.b.fastBitmap.getWidth()) {
                                if (Minimum.this.b.getRed(i15, i17) < red) {
                                    red = Minimum.this.b.getRed(i15, i17);
                                }
                                if (Minimum.this.b.getGreen(i15, i17) < green) {
                                    green = Minimum.this.b.getGreen(i15, i17);
                                }
                                if (Minimum.this.b.getBlue(i15, i17) < blue) {
                                    blue = Minimum.this.b.getBlue(i15, i17);
                                }
                            }
                            i16++;
                            red = red;
