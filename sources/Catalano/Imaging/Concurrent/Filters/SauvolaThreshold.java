        ...
        public void run() {
            for (int i = this.b.startX; i < this.b.endHeight; i++) {
                for (int i2 = 0; i2 < this.b.fastBitmap.getWidth(); i2++) {
                    this.b.fastBitmap.setGray(i, i2, ((double) ((float) this.b.fastBitmap.getGray(i, i2))) > ((double) ((float) SauvolaThreshold.this.e.getGray(i, i2))) * ((((Math.sqrt((double) ((float) SauvolaThreshold.this.f.getGray(i, i2))) / SauvolaThreshold.this.d) - 1.0d) * SauvolaThreshold.this.c) + 1.0d) ? 255 : 0);
                }
            }
        }
    }
