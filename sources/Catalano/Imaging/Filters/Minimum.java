                    ...
                    while (i4 < iA) {
                        ...
                        for (int i6 = 0; i6 < iA; i6++) {
                            ...
                            if (i5 >= 0 && i5 < height && i7 >= 0 && i7 < width) {
                                iMin = Math.min(iMin, fastBitmap2.getGray(i5, i7));
                            }
                        }
                        i4++;
                        i3 = iMin;
                    ...
                    while (i11 < iA) {
                        ...
                        for (int i16 = 0; i16 < iA; i16++) {
                            ...
                            if (i14 >= 0 && i14 < height && i17 >= 0 && i17 < width) {
                                iMin3 = Math.min(iMin3, fastBitmap2.getRed(i14, i17));
                                iMin4 = Math.min(iMin4, fastBitmap2.getGreen(i14, i17));
                                iMin2 = Math.min(iMin2, fastBitmap2.getBlue(i14, i17));
                            }
                        }
                        i11++;
                        i10 = iMin2;
