...
public final class Auth {
    ...
    private static final Api.zza<zzki, zza> a = new Api.zza<zzki, zza>() { // from class: com.google.android.gms.auth.api.Auth.1
    ...
    private static final Api.zza<zzkb, Api.ApiOptions.NoOptions> c = new Api.zza<zzkb, Api.ApiOptions.NoOptions>() { // from class: com.google.android.gms.auth.api.Auth.3
        @Override // com.google.android.gms.common.api.Api.zza
        /* JADX INFO: renamed from: a, reason: merged with bridge method [inline-methods] */
    ...
    private static final Api.zza<zzkf, Api.ApiOptions.NoOptions> d = new Api.zza<zzkf, Api.ApiOptions.NoOptions>() { // from class: com.google.android.gms.auth.api.Auth.4
        @Override // com.google.android.gms.common.api.Api.zza
        /* JADX INFO: renamed from: a, reason: merged with bridge method [inline-methods] */
    ...
    private static final Api.zza<zzg, com.google.android.gms.auth.api.signin.zzg> e = new Api.zza<zzg, com.google.android.gms.auth.api.signin.zzg>() { // from class: com.google.android.gms.auth.api.Auth.5
        @Override // com.google.android.gms.common.api.Api.zza
        /* JADX INFO: renamed from: a, reason: merged with bridge method [inline-methods] */
    ...
    private static final Api.zza<zzb, GoogleSignInConfig> f = new Api.zza<zzb, GoogleSignInConfig>() { // from class: com.google.android.gms.auth.api.Auth.6
        @Override // com.google.android.gms.common.api.Api.zza
        /* JADX INFO: renamed from: a, reason: merged with bridge method [inline-methods] */
    ...
    public static final Api<zza> PROXY_API = new Api<>("Auth.PROXY_API", a, zzRE);
    public static final Api<AuthCredentialsOptions> CREDENTIALS_API = new Api<>("Auth.CREDENTIALS_API", b, zzRF);
    public static final Api<com.google.android.gms.auth.api.signin.zzg> zzRQ = new Api<>("Auth.SIGN_IN_API", e, zzRH);
    public static final Api<GoogleSignInConfig> zzRR = new Api<>("Auth.GOOGLE_SIGN_IN_API", f, zzRI);
    public static final Api<Api.ApiOptions.NoOptions> zzRS = new Api<>("Auth.ACCOUNT_STATUS_API", c, zzRG);
    public static final Api<Api.ApiOptions.NoOptions> zzRT = new Api<>("Auth.CONSENT_API", d, zzRJ);
    ...
    public static final class AuthCredentialsOptions implements Api.ApiOptions.Optional {
        ...
        public static class Builder {
            private PasswordSpecification a = PasswordSpecification.zzSt;
        }
