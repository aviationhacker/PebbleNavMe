...
public class zzb implements Parcelable.Creator<CredentialPickerConfig> {
    static void a(CredentialPickerConfig credentialPickerConfig, Parcel parcel, int i) {
        ...
        com.google.android.gms.common.internal.safeparcel.zzb.zzc(parcel, CredentialsApi.ACTIVITY_RESULT_ADD_ACCOUNT, credentialPickerConfig.a);
    ...
    public CredentialPickerConfig createFromParcel(Parcel parcel) {
        ...
        return new CredentialPickerConfig(iZzg, zZzc2, zZzc);
    }
