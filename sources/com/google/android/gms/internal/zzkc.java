...
public interface zzkc extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzkc {
        ...
        static class a implements zzkc {
            private IBinder a;
        ...
        public static zzkc zzan(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzkc)) ? new a(iBinder) : (zzkc) iInterfaceQueryLocalInterface;
        }
