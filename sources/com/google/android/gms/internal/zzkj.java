...
public interface zzkj extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzkj {
        ...
        static class a implements zzkj {
            private IBinder a;
        ...
        public static zzkj zzav(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzkj)) ? new a(iBinder) : (zzkj) iInterfaceQueryLocalInterface;
        }
