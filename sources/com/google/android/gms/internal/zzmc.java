...
public interface zzmc extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzmc {
        ...
        static class a implements zzmc {
            private IBinder a;
        ...
        public static zzmc zzaP(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzmc)) ? new a(iBinder) : (zzmc) iInterfaceQueryLocalInterface;
        }
