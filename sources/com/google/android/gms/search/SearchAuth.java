...
public class SearchAuth {
    private static final Api.zza<zzqs, Api.ApiOptions.NoOptions> a = new Api.zza<zzqs, Api.ApiOptions.NoOptions>() { // from class: com.google.android.gms.search.SearchAuth.1
    ...
    public static final Api.zzc<zzqs> zzRk = new Api.zzc<>();
    public static final Api<Api.ApiOptions.NoOptions> API = new Api<>("SearchAuth.API", a, zzRk);
