...
public class ArrayUtils {
    ...
    public static <T> T[] add(T[] tArr, T t) {
        ...
        T[] tArr2 = (T[]) ((Object[]) a(tArr, cls));
        tArr2[tArr2.length - 1] = t;
        return tArr2;
    }

    public static boolean[] add(boolean[] zArr, boolean z) {
        boolean[] zArr2 = (boolean[]) a(zArr, (Class<?>) Boolean.TYPE);
    ...
    public static double[] add(double[] dArr, double d) {
        double[] dArr2 = (double[]) a(dArr, (Class<?>) Double.TYPE);
        dArr2[dArr2.length - 1] = d;
        return dArr2;
    }

    public static float[] add(float[] fArr, float f) {
        float[] fArr2 = (float[]) a(fArr, (Class<?>) Float.TYPE);
    ...
    public static long[] add(long[] jArr, long j) {
        long[] jArr2 = (long[]) a(jArr, (Class<?>) Long.TYPE);
        jArr2[jArr2.length - 1] = j;
        return jArr2;
    }

    public static short[] add(short[] sArr, short s) {
        short[] sArr2 = (short[]) a(sArr, (Class<?>) Short.TYPE);
    ...
    public static <T> T[] add(T[] tArr, int i, T t) {
        ...
        return (T[]) ((Object[]) a(tArr, i, t, componentType));
    }
