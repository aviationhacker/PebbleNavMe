...
public class CharSet implements Serializable {
    ...
    private final Set<mk> a = Collections.synchronizedSet(new HashSet());
        ...
        if (str != null) {
            ...
            while (i < length) {
                ...
                if (i2 >= 4 && str.charAt(i) == '^' && str.charAt(i + 2) == '-') {
                    this.a.add(mk.b(str.charAt(i + 1), str.charAt(i + 3)));
                    i += 4;
                } else if (i2 >= 3 && str.charAt(i + 1) == '-') {
                    this.a.add(mk.a(str.charAt(i), str.charAt(i + 2)));
                    i += 3;
                } else if (i2 >= 2 && str.charAt(i) == '^') {
                    this.a.add(mk.b(str.charAt(i + 1)));
                    i += 2;
                } else {
                    this.a.add(mk.a(str.charAt(i)));
                    i++;
                }
            }
        }
