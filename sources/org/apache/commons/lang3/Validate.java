...
public class Validate {
    ...
    public static void isTrue(boolean z, String str, double d) {
        if (!z) {
            throw new IllegalArgumentException(String.format(str, new Double(d)));
        }
    }
    ...
    public static void isInstanceOf(Class<?> cls, Object obj) {
        if (!cls.isInstance(obj)) {
            throw new IllegalArgumentException(String.format("The validated object is not an instance of %s", cls.getName()));
        }
    }
    ...
    public static void isAssignableFrom(Class<?> cls, Class<?> cls2) {
        if (!cls.isAssignableFrom(cls2)) {
            throw new IllegalArgumentException(String.format("The validated class can not be converted to the %s class", cls.getName()));
        }
    }
