...
public class ExceptionUtils {
    ...
    public static String[] getRootCauseStackTrace(Throwable th) {
        ...
        ArrayList arrayList = new ArrayList();
        List<String> listA = a(throwables[length - 1]);
        int i = length;
        while (true) {
            int i2 = i - 1;
            if (i2 >= 0) {
                if (i2 != 0) {
                    List<String> listA2 = a(throwables[i2 - 1]);
                    removeCommonFrames(listA, listA2);
                    list = listA2;
                } else {
                    list = listA;
                }
    ...
    public static String[] getStackFrames(Throwable th) {
        return th == null ? ArrayUtils.EMPTY_STRING_ARRAY : a(getStackTrace(th));
    }
    ...
    static List<String> a(Throwable th) {
