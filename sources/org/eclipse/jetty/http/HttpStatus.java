...
public class HttpStatus {
    ...
    public enum Code {
        ...
        NON_AUTHORITATIVE_INFORMATION(HttpStatus.NON_AUTHORITATIVE_INFORMATION_203, "Non Authoritative Information"),
        NO_CONTENT(HttpStatus.NO_CONTENT_204, "No Content"),
        RESET_CONTENT(HttpStatus.RESET_CONTENT_205, "Reset Content"),
        ...
        public String toString() {
            return String.format("[%03d %s]", Integer.valueOf(this.a), getMessage());
        }

        public boolean isInformational() {
            return HttpStatus.isInformational(this.a);
        }

        public boolean isSuccess() {
            return HttpStatus.isSuccess(this.a);
        }

        public boolean isRedirection() {
            return HttpStatus.isRedirection(this.a);
        }

        public boolean isClientError() {
            return HttpStatus.isClientError(this.a);
        }

        public boolean isServerError() {
            return HttpStatus.isServerError(this.a);
        }
    }
